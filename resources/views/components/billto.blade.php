<div class="container section-border" id="pa">
    ...
    <div class="row ">
        ...
        <div class="col-md-4 pl-1 ml-3">
           ...
           <span class="text-capitalize bg-color-grey pt-0 pb-0 ml-1">{{ session()->get('selected_customer')['name'] }}</span>
            </div>
            ...
            <div class="row">
                ...
                <span class="text-capitalize bg-color-grey pt-0 pb-0 ml-1">{{ session()->get('selected_customer')['company_name'] }}</span>
            </div>
            ...
            <div class="row">
                ...
                <span class="text-capitalize bg-color-grey pt-0 pb-0 ml-1">{{ session()->get('selected_customer')['address'] }}</span>
            ...
            <div class="row">
                ...
                <span class="text-capitalize bg-color-grey pt-0 pb-0 ml-1">{{ session()->get('selected_customer')['city']  }} {{ session()->get('selected_customer')['state'] }}</span>    
            </div>
            ...
            <div class="row">
                ...
                <span class="text-capitalize bg-color-grey pt-0 pb-0 ml-1">{{ session()->get('selected_customer')['pincode'] }}</span>
            ...
            <div class="row">
                <span class="section-heading ml-1">GST :</span><input type="text" class="no-border section-heading text-capitalize ml-2 bg-color-grey" placeholder="GSt">
