...
<div class="container d-flex justify-content-center align-items-center">
    <div>
        <p class="h5 text-warning">Customer's Information</p>
    </div>
</div>
    ...
    <form>
        ...
        <div class="form-row">
            ...
            <div class="form-group input-group col-md-6">
                ...
                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $customer->email }}" readonly required autocomplete="email" placeholder="Email Address">
        ...
        <input type="text" value="{{$customer->id}}" readonly hidden name="id" id="id">
        ...
        <div class="form-row mt-3">
            ...
            <div class="form-group input-group col-md-2">
                ...
                <div class="input-group-prepend">
                  ...
                  <input id="pincode" type="number" class="form-control @error('pincode') is-invalid @enderror" name="pincode" value="{{ $customer->pincode }}" readonly required autocomplete="pincode" placeholder="pincode">
            ...
            <div class="form-group input-group col-md-4">
                ...
                <div class="input-group-prepend">
                  ...
                  <input id="mobile" type="number" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ $customer->mobile }}" readonly required autocomplete="mobile" placeholder="Contact Number">
        ...
        <div class="form-row mt-5">
                ...
                <button  class="btn btn-success d-inline-block col-md-6" onclick="redirect_to(event)" id="{{$customer->id}}">
                        {{ __('Click here to update customer') }}
                    </button>
                </div>
...
function redirect_to(e) {
    
    e.preventDefault();
    id = event.target.id;
    location.href = '/user/update_customer/info/'+id;
}
