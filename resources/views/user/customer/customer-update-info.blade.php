    ...
    <div class="form-row">
        ...
        <div class="form-group input-group col-md-6">
            ...
            <div class="input-group-prepend">
              ...
              <input id="name" type="text" class="form-control text-capitalize @error('name') is-invalid @enderror" name="name" value="{{ $customer->name }}" required autocomplete="name" autofocus placeholder="Customer Name">
    ...
    <div class="form-row mt-3">
        ...
        <div class="form-group input-group col-md-5">
            ...
            <div class="input-group-prepend">
              ...
              <input id="company_name" type="text" class="form-control text-capitalize @error('company_name') is-invalid @enderror" name="company_name" value="{{ $customer->company_name }}" required autocomplete="company_name" placeholder="Name of Company">
    ...
    <input type="text" value="{{$customer->id}}" hidden name="id" id="id">
        ...
        <div class="form-group input-group col-md-7">
            ...
            <div class="input-group-prepend">
              ...
              <input id="address" type="text" class="form-control text-capitalize @error('address') is-invalid @enderror" name="address" value="{{ $customer->address }}" required autocomplete="address" placeholder="Address Of Company">
    ...
    <div class="form-row mt-3">
        <div class="form-group input-group col-md-2">
            ...
            <div class="input-group-prepend">
              ...
              <input id="country" type="text" class="form-control text-capitalize @error('country') is-invalid @enderror" name="country" value="{{ $customer->country }}" required autocomplete="country" placeholder="Country">
        ...
        <div class="form-group input-group col-md-2">
            ...
            <div class="input-group-prepend">
              ...
              <input id="state" type="text" class="form-control text-capitalize @error('state') is-invalid @enderror" name="state" value="{{ $customer->state }}" required autocomplete="state" placeholder="State">
        ...
        <div class="form-group input-group col-md-2">
            ...
            <div class="input-group-prepend">
              ...
              <input id="city" type="text" class="form-control text-capitalize @error('city') is-invalid @enderror" name="city" value="{{ $customer->city }}" required autocomplete="city" placeholder="City">
