    ...
    <div class="form-row mt-3">
        <div class="form-group input-group col-md-5">
            ...
            <div class="input-group-prepend">
              ...
              <input id="gstn" type="text" class="form-control text-capitalize @error('gstn') is-invalid @enderror" name="gstn" value="{{ old('gstn') }}" required autocomplete="country" placeholder="GSTN">
